<template>
  <div class="page-card">
    <div class="page-header">
      <div>
        <div class="page-title">Progresso Semanal</div>
        <div class="page-subtitle">
          Acompanhe em tempo real o progresso de cada barbeiro em relação à meta semanal. Atualizado a cada 10 segundos.
        </div>
      </div>
      <span class="tag">Dashboard • Progresso</span>
    </div>
    ...
    <div class="grid-2">
      <section class="panel">
        <div class="panel-header">
          ...
          <span class="chip">Meta da semana exibida como 100%</span>
        </div>
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            <tr v-for="row in progress" :key="row.barberId">
              ...
              <td>
                {{ formatPercent(row.dailyGoalPercent) }}
              </td>
              <td>
      ...
      <section class="panel">
        <div class="panel-header">
          ...
          <span class="chip">Conclusão relativa por barbeiro</span>
        </div>
