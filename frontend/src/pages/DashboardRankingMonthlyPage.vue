<template>
  <div class="page-card">
    <div class="page-header">
      <div>
        <div class="page-title">Ranking Mensal</div>
        <div class="page-subtitle">
          Visão competitiva dos barbeiros ordenados pela conclusão da meta mensal.
        </div>
      </div>
      <span class="tag">Dashboard • Ranking Mensal</span>
    </div>
    ...
    <div class="grid-2">
      <section class="panel">
        ...
        <div v-if="ranking.length === 0" class="page-subtitle">
          Nenhum dado para este mês ainda.
        </div>
      ...
      <section class="panel">
        <div class="panel-header">
          ...
          <span class="chip">Gráfico de barras horizontal (mês)</span>
        </div>
...
async function loadData() {
  const data = await dashboardService.getMonthlyRanking();
  ranking.value = data;
